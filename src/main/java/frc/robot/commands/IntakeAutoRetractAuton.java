 ...
 */
public class IntakeAutoRetractAuton extends SequentialCommandGroup {
  /** Creates a new IntakeAutoRetract. */
  public IntakeAutoRetractAuton() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new ParallelRaceGroup(new IntakeBasePos(), new SequentialCommandGroup(new WaitCommand(.1), new IntakeWaitPosition()))
      );
  }
}
