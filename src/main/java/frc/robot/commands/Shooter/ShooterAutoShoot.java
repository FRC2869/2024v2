...
public class ShooterAutoShoot extends ParallelRaceGroup {
  ...
  public ShooterAutoShoot() {
    ...
    addCommands(new IntakeBasePos(), new SequentialCommandGroup( new ShooterShoot(), new WaitCommand(1), new IntakeSpinOut(), new WaitCommand(0.5), new ShooterStop(), new IntakeSpinStop()));
