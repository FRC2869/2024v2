...
public class ShooterAutoShootTeleop extends ParallelRaceGroup {
  ...
  public ShooterAutoShootTeleop() {
    ...
    addCommands(new IntakeClosePos(), new PivotClose(), new SequentialCommandGroup(new ShooterShoot(), new ShooterRevWait().withTimeout(2), new WaitCommand(.25), new IntakeSpinOut(), new WaitCommand(1), new IntakeSpinStop(), new ShooterStop()));
