 ...
 */
public class ShooterWaitPosition extends Command {
  private PivotSubsystem shooter;

  /** Creates a new IntakeWaitPosition. */
  public ShooterWaitPosition() {
    shooter = PivotSubsystem.getInstance();
